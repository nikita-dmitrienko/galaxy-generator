...
const generateGalaxy = () => {
    ...
    for (let i = 0; i < parameters.count; i += 1) {
        ...
        // position
        const radius = Math.random() * parameters.branches;
    ...
    const positions = new Float32Array(positionsColl, 3);
    const colors = new Float32Array(colorsColl, 3);
